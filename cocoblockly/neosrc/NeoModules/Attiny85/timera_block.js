    ...
    init: function() {
      ...
      this.appendDummyInput()
        ...
        this.appendDummyInput()
            ...
            .appendField(new Blockly.FieldDropdown([
                ["Default", "default"],                 
                ["Normal port operation, OC0A disconnected.", "0"], 
                ["Clear OC0A on Compare Match, set OC0A at BOTTOM (non-inverting mode)", "2"], 
                ["Set OC0A on Compare Match, clear OC0A at BOTTOM (inverting mode)", "3"]         
              ]), "COMPARE_MODE_A");
              ...
              .appendField(new Blockly.FieldDropdown([
                  ["Default", "default"],                 
                  ["Normal port operation, OC0B disconnected.", "0"], 
                  ["Clear OC0B on Compare Match, set OC0B at BOTTOM (non-inverting mode)", "2"], 
                  ["Set OC0B on Compare Match, clear OC0B at BOTTOM (inverting mode)", "3"]         
                ]), "COMPARE_MODE_B");
